      ...
      <body class="indigo lighten-4">
        <div class="header">
          <div class="row" style={{marginTop:30}}>
            <div class = "col-2">
              <img src="queen.jpg" style={{width:75, height:50, float:"right"}}></img>
            </div>
            <div class = "col-4">
              <h3>Queen's Gambit</h3>
              <p>Stream Unlockable NFTs</p>
            </div>
            <div class= "col-6">
        ...
        <div class = "content">
          ...
          <div class="row">  
            ...
            <div class="col-3 nft-cards">
              <div class="card-body">
                <img class="unlockable-nft" src="lockable-nft1.jpg"></img>
                <progress id="nft1" value="100" max="100"> 32% </progress>
              </div>
            ...
            <div class="col-3 nft-cards">
              <div class="card-body">
                <img class="unlockable-nft" src="lockable-nft2.jpg"></img>
                <progress id="nft2" value="77" max="100"> 32% </progress>
              </div>
            </div>

            <div class="col-3 nft-cards">
              <div class="card-body">
                <img class="unlockable-nft" src="lockable-nft3.jpg"></img>
                <progress id="nft3" value="0" max="100"> 32% </progress>
              </div>
            </div>
          ...
          <div class="row">  
            ...
            <div class="card col-3 interact-card1">
              <div class="card-body">
                <h5 class="card-title">Mint/Append</h5>
                <table>
                  <tr>
                    <td>NFT Contract Address   </td>
                    <td> <input type="text" id="nft-contract-address"/> </td>
                  </tr>
                  <tr>
                    <td>Token ID</td>
                    <td> <input type="number" id="token-id"/> </td>
                  </tr>
                  <tr>
                    <td></td>
                    <button class="button_slide slide_right" id="mint">Add to SNUFT</button>
                  </tr>
                </table>
              </div>
            </div>

            <div class="card col-3 interact-card2">
              <div class="card-body">
                <h5 class="card-title">Start Unlock Stream</h5>
                <table>
                  <tr>
                    <td>Stream Amount (DAIx/month)</td>
                    <td> <input type="text" id="nft-contract-address"/> </td>
                  </tr>
                  <tr>
                    <td>SNUFT Token ID</td>
                    <td> <input type="number" id="token-id"/> </td>
                  </tr>
                  <tr>
                    <td></td>
                    <button class="button_slide slide_right" id="start-stream">Start Stream</button>
                  </tr>
                </table>
                <p style={{marginTop:30}}>Your Balance: <span id='balance-0x0F1D7C55A2B133E000eA10EeC03c774e0d6796e8'>0</span> USDCx</p>
